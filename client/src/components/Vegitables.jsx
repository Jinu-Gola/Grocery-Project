...
function Vegitables() {
    return (
        <>
            ...
            {/* <div className="container-fluid vegitable py-5">
                <div className="container py-5">
                    <h1 className="mb-0">Fresh Organic Vegetables</h1>
                    <div className="owl-carousel vegetable-carousel justify-content-center">
                        <div className="border border-primary rounded position-relative vegitable-item">
                            <div className="vegitable-img">
                                        ...
                                        <div className="row g-4">
                                            <div className="col-md-6 col-lg-4 col-xl-3">
                                                <div className="rounded position-relative fruite-item">
                                                    ...
                                                    <div className="text-white bg-secondary px-3 py-1 rounded position-absolute" style={{ top: 10, right: 10 }}>Vegitable</div>

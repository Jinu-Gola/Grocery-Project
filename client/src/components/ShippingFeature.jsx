    ...
    return (
        <>
            ...
            <div className="container-fluid page-header1 py-5 ">
                <h1 className="text-center text-white display-6">Shipping</h1>
                ...
                <div className="container py-5">
                    <div className="col-12">
                        <div className="text-center mx-auto" style={{ maxWidth: 700 }}>
                            <h1 className="text-primary">Free Shipping</h1>
                            ...
                            <div className="col-lg-5">
                                <div className="d-flex p-4 rounded mb-4 bg-white">
                                    <p style={{
                                        height: "350px",
                                        width: "550px",
                                        backgroundImage: "url(" + "./assets/img/delivery.jpg" + ")",
                                ...
                                <div className="col-lg-5">
                                    <div className="d-flex p-4 rounded mb-4 bg-white">
                                        <p style={{
                                            height: "350px",
                                            width: "550px",
                                            backgroundImage: "url(" + "./assets/img/d1.jpg" + ")",
                                            paddingTop: "100px",
                                            backgroundSize: "contain",
                                            backgroundRepeat: "no-repeat",
                                        }}
